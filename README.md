...
This is an example application that shows how `next-auth` is applied to a basic Next.js app. This
is an updated version of [`next-auth-example`](https://github.com/nextauthjs/next-auth-example) to use Next.js 13 and the app router.
